...
import { Briefcase, Users, CalendarDays, ArrowRight, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Overview of recruitment activities and statistics.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            ...
            <Link to="/hr/interviews" className="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-primary-200 hover:bg-primary-50 transition-colors group">
              <div className="flex items-center gap-3">
                <div className="bg-gray-100 text-gray-600 p-2 rounded-lg group-hover:bg-primary-100 group-hover:text-primary-600 transition-colors">
                  <CalendarDays size={20} />
                </div>
                <span className="font-medium text-gray-700 group-hover:text-primary-700">Upcoming Interviews</span>
              </div>
              <ArrowRight size={16} className="text-gray-400 group-hover:text-primary-600" />
            </Link>
          </div>
