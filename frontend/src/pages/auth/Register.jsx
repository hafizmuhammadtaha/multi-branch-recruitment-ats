        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                disabled
                className="mt-1 block w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-xl text-gray-500 cursor-not-allowed"
              >
                <option value="candidate">Candidate</option>
              </select>
              <p className="mt-1 text-xs text-gray-500">Currently only accepting candidate registrations</p>
            </div>
          </div>
